...
var _ resource.Resource = &ServiceEndpointDockerRegistryResource{}
...
func (r *ServiceEndpointDockerRegistryResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resourceShema := GetServiceEndpointResourceSchemaBase("Manages a Docker Registry service endpoint within an Azure DevOps project.")
	resourceShema.Attributes["password"] = schema.StringAttribute{
		MarkdownDescription: "Docker registry password.",
		Required:            true,
		Sensitive:           true,
	...
	resourceShema.Attributes["username"] = schema.StringAttribute{
		MarkdownDescription: "Docker registry username.",
		Required:            true,
		Sensitive:           true,
		Validators: []validator.String{
			validators.StringNotEmpty(),
...
func (r *ServiceEndpointDockerRegistryResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var model *ServiceEndpointDockerRegistryResourceModel
...
func (r *ServiceEndpointDockerRegistryResource) getCreateOrUpdateServiceEndpointArgs(model *ServiceEndpointDockerRegistryResourceModel) *serviceendpoints.CreateOrUpdateServiceEndpointArgs {
	...
	return &serviceendpoints.CreateOrUpdateServiceEndpointArgs{
		...
		Type:              serviceendpoints.ServiceEndpointTypeDockerRegistry,
		Url:               model.URL,
